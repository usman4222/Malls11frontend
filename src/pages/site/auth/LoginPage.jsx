          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="remember"
                  className="border-gray-600 data-[state=checked]:bg-gray-500 data-[state=checked]:text-white"
                />
                <Label htmlFor="remember" className="text-sm text-gray-400">
                  Remember me
                </Label>
              </div>
              <a href="/forget-password" className="text-sm text-gray-400 hover:text-black">
                Forgot password?
              </a>
            </div>
